...
async function main() {
  ...
  const residentSeeds = [
    // A 棟 — 高樓層、大坪數
    { code: 'A0301', sqm: 45.20, name: '張凱翔', username: 'resident_a0301', email: 'jeje898281@gmail.com' },
    { code: 'A0302', sqm: 42.80, name: '陳怡君', username: 'resident_a0302', email: 'ctkho0828@gmail.com' },
    { code: 'A0501', sqm: 48.10, name: '林宗翰', username: 'resident_a0501', email: 'resident.a0501@example.com' },
    { code: 'A0502', sqm: 45.50, name: '王思婷', username: 'resident_a0502', email: 'resident.a0502@example.com' },
    { code: 'A0701', sqm: 50.30, name: '吳俊宏', username: 'resident_a0701', email: 'resident.a0701@example.com' },
    { code: 'A0702', sqm: 47.90, name: '蔡淑芬', username: 'resident_a0702', email: 'resident.a0702@example.com' },
    { code: 'A0901', sqm: 55.40, name: '黃文豪', username: 'resident_a0901', email: 'resident.a0901@example.com' },
    { code: 'A0902', sqm: 52.20, name: '楊麗華', username: 'resident_a0902', email: 'resident.a0902@example.com' },
    { code: 'A1101', sqm: 62.80, name: '劉建良', username: 'resident_a1101', email: 'resident.a1101@example.com' },
    { code: 'A1102', sqm: 60.50, name: '謝佩珊', username: 'resident_a1102', email: 'resident.a1102@example.com' },

    // B 棟 — 中段標準戶
    { code: 'B0201', sqm: 32.10, name: '鄭家豪', username: 'resident_b0201', email: 'resident.b0201@example.com' },
    { code: 'B0202', sqm: 30.80, name: '許雅雯', username: 'resident_b0202', email: 'resident.b0202@example.com' },
    { code: 'B0401', sqm: 33.50, name: '潘志強', username: 'resident_b0401', email: 'resident.b0401@example.com' },
    { code: 'B0402', sqm: 32.40, name: '簡宜君', username: 'resident_b0402', email: 'resident.b0402@example.com' },
    { code: 'B0601', sqm: 35.20, name: '蘇正雄', username: 'resident_b0601', email: 'resident.b0601@example.com' },
    { code: 'B0602', sqm: 33.90, name: '高麗珠', username: 'resident_b0602', email: 'resident.b0602@example.com' },
    { code: 'B0801', sqm: 36.70, name: '馬建興', username: 'resident_b0801', email: 'resident.b0801@example.com' },
    { code: 'B0802', sqm: 34.50, name: '彭素芬', username: 'resident_b0802', email: 'resident.b0802@example.com' },
    { code: 'B1001', sqm: 38.10, name: '邱俊傑', username: 'resident_b1001', email: 'resident.b1001@example.com' },
    { code: 'B1002', sqm: 36.40, name: '葉宛真', username: 'resident_b1002', email: 'resident.b1002@example.com' },

    // C 棟 — 低樓層、小坪數
    { code: 'C0101', sqm: 22.30, name: '阮志明', username: 'resident_c0101', email: 'resident.c0101@example.com' },
    { code: 'C0102', sqm: 21.50, name: '柯曉雯', username: 'resident_c0102', email: 'resident.c0102@example.com' },
    { code: 'C0201', sqm: 24.10, name: '賴家興', username: 'resident_c0201', email: 'resident.c0201@example.com' },
    { code: 'C0202', sqm: 23.40, name: '范佩玲', username: 'resident_c0202', email: 'resident.c0202@example.com' },
    { code: 'C0301', sqm: 25.80, name: '游文宏', username: 'resident_c0301', email: 'resident.c0301@example.com' },
    { code: 'C0302', sqm: 24.60, name: '羅淑惠', username: 'resident_c0302', email: 'resident.c0302@example.com' },
    { code: 'C0401', sqm: 26.10, name: '丁建良', username: 'resident_c0401', email: 'resident.c0401@example.com' },
    { code: 'C0402', sqm: 25.40, name: '杜美玲', username: 'resident_c0402', email: 'resident.c0402@example.com' },
    { code: 'C0501', sqm: 27.20, name: '宋志偉', username: 'resident_c0501', email: 'resident.c0501@example.com' },
  ...
  //
  // 門檻欄位語意：
  //   sqmThreshold      = 出席坪數 / 社區總坪數 應達的「百分比」（0~100）
  //   residentThreshold = 出席戶數應達的「絕對戶數」（整數）
  // 本社區共 32 戶。首次召集依公寓大廈管理條例為 2/3（66.7% / 22 戶），
  // 重新召集放寬至 1/5（20% / 7 戶）。一般決議過半（50% / 16 戶），
  // 重大決議（如外牆拉皮、修改規約）需 3/4（75% / 24 戶）表決同意
  // ============================================================
  ...
  // ---- 會議 6 第三季財務檢討（預定，提案已排定但尚未開放表決，故無投票紀錄）----
  await prisma.proposal.create({
    data: {
      meetingId: upcomingQ3.id,
      title: '承認 114 年度第二季收支結算表',
      content:
        '提請承認第二季公共基金收支結算表，含管理費收入、清潔保全人事、公設水電與電梯保養等支出明細，詳會議手冊附件一。',
      sqmThreshold: 50,
      residentThreshold: 16,
      createAdminUserId: viceChair.id,
    },
  ...
  await prisma.proposal.create({
    data: {
      meetingId: upcomingQ3.id,
      title: '提撥 80 萬元設立電梯與機電設備長期修繕準備金',
      content:
        '三棟電梯與機電設備陸續邁入第二個保養週期，為避免未來大額維修一次性衝擊管理費，建議自公共基金提撥 80 萬元設立專戶，分年累積。',
      sqmThreshold: 50,
      residentThreshold: 16,
      createAdminUserId: viceChair.id,
    },
  ...
  await prisma.proposal.create({
    data: {
      meetingId: upcomingQ3.id,
      title: '社區中庭景觀重新規劃與植栽汰換案',
      content:
        '現有中庭植栽多有老化與排水不良問題。提案委由景觀廠商重新規劃並汰換植栽、增設自動灌溉，預算 35 萬元，自公共基金支應。',
      sqmThreshold: 50,
      residentThreshold: 16,
      createAdminUserId: chair.id,
    },
  ...
  console.log(`提案     ：15 條（1 流會未表決、1 否決、9 通過、3 預定待表決、含進行中 1 尚未開放）`);
  console.log('');
  console.log('=== 管理員登入 ===');
  console.log('admin001    / test1234      （系統管理員）');
  console.log('mthompson   / manager123    （主委 Michael）');
  console.log('smitchell   / manager123    （副主委 Sarah）');
  console.log('jrodriguez  / assist123     （會議助理 Jennifer）');
  console.log('dpark       / assist123     （會議助理 David）');
  console.log('rwilson     / disabled123   （已停用，登入應被拒絕）');
  console.log('');
  console.log('=== 住戶登入 ===');
  console.log('username = resident_<門牌小寫>   password = <門牌小寫>123');
  console.log('例：resident_a0301 / a0301123');
}
